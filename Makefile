...
# disable print directory for make
...
config: $(LM) .config
	@$(LM) --projcfg .config --lmcfg lm.cfg --out ./sgl/source/sgl_config.h --mk .lm.mk --mem 50
	@$(MAKE) clean
